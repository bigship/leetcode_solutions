 ...
 * string s1 can break some permutation of string s2 or vice-versa (in other words s2 can break s1).
...
for s2="acd" are: "acd", "adc", "cad", "cda", "dac" and "dca". However, there is not any permutation from s1
