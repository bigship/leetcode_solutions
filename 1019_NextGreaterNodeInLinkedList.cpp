...
next_larger(node_i) is the node_j.val such that j > i, node_j.val > node_i.val,
...
represent the serialization of a linked list with a head node value of 2, second node value of 1,
